...
export const mockVideos: VideoContent[] = [
  {
    ...
    videoUrl: "https://www.youtube.com/embed/iGTGXVsWk7c",
    duration: "25:35",
    instructor: "Sam Gatana",
    category: "Songwriting",
    level: "beginner",
    tags: ["vocals", "warm-up", "technique", "songwriting", "guitar"],
    isLocked: false,
    accessLevel: 'free',
  },
  {
  ...
  },
  {
    ...
    thumbnailUrl: "https://images.unsplash.com/photo-1692303365672-3f04586f5deb?q=80&w=1470&auto=format&fit=crop",
