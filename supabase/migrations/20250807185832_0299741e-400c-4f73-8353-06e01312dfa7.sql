-- Atomic migration for media access + Backblaze integration support
DO $$
DECLARE
  free_id integer;
BEGIN
  ...
  IF NOT EXISTS (
    ...
    ALTER TABLE public.profiles ADD COLUMN access_tier_id integer;
    ...
    ALTER TABLE public.profiles ALTER COLUMN access_tier_id SET DEFAULT free_id;
  END IF;
END $$;

-- media_files RLS and columns
